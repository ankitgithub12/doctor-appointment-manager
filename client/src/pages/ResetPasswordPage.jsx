        ...
        <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-md space-y-6">
          ...
          {success ? (
            <div className="space-y-4">
              ...
              <Link
                to="/login"
                className="w-full text-center bg-teal-500 hover:bg-teal-400 text-slate-950 py-3 rounded-lg text-sm font-bold shadow-lg shadow-teal-500/10 block transition"
              >
                Sign In Now
              </Link>
            </div>
