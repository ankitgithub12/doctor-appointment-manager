...
import { FaPhoneAlt, FaWhatsapp, FaCheck, FaPhone, FaUser, FaClipboardList, FaLeaf, FaClock } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 pt-28 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        <div className="bg-white border border-slate-100 rounded-3xl p-8 md:p-12 shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3.5 text-xs md:text-sm text-slate-600 font-medium">
              <li className="flex items-center gap-2.5">
                <span className="w-5 h-5 rounded-full bg-teal-50 text-teal-600 flex items-center justify-center text-xs border border-teal-100">
                  <FaCheck />
                </span>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2.5 px-5 rounded-xl flex items-center gap-2 text-xs transition-all shadow-md hover:shadow-lg hover:shadow-emerald-500/20 active:scale-[0.98] cursor-pointer"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl py-2 pl-8 pr-3 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 transition"
                      value={name}
